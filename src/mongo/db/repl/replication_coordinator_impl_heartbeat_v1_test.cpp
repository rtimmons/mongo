...
TEST_F(ReplCoordHBV1Test,
    ...
    log() << "RST : logQueues prior to sending heartbeat";
    getNet()->logQueues();
    log() << "RST : after logQueues prior to sending heartbeat";

    log() << "RST : receiveHeartbeatFrom";
